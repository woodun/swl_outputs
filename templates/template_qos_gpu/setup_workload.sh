...
#ln -s $benchmarks/pthread_benchmark/* .
...
for APP1; do
        ...
        for APP2; do
                mkdir $APP1\_$APP2
                cd $APP1\_$APP2
                ln -s $benchmarks/pthread_benchmark/$APP1 .
                ln -s $benchmarks/pthread_benchmark/$APP2 .
                ln -s $benchmarks/pthread_benchmark/gpgpu_ptx_sim__mergedapps .
                ln -s $benchmarks/pthread_benchmark/run_scripts/mainscript_$APP1\_$APP2 .
                cd ../
        done
done
